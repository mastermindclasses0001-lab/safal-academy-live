...
if api_key:
    ...
    if not st.session_state.test_active:
        ...
        if st.sidebar.button("🚀 Start Interactive Test"):
            if not topic:
                ...
                # UPDATED: AI is now explicitly instructed to be "Ravish Sir"
                st.session_state.system_prompt = (
    ...
    st.markdown("<p style='color: #facc15; text-align: center; font-size: 20px; margin-top: 50px;'>⚠️ Kripya aage badhne ke liye sidebar mein apni Groq API key enter karein.</p>", unsafe_allow_html=True)